...
func del_by_hash[K, V](m: Map[K, V], keyHash: Hash): Map[K, V]  =
  var res = m
  res.root = copyRef(m.root)
...
proc `==`*[K, V](m1: Map[K, V], m2: Map[K, V]): bool  =
